...
The predictors `displacement`, `weight`, `year`, and `origin` appear to have a statistically significant relationship to the response at 99% significant level. 
...
I can reject `Price` and `USYes` based on their respective p-values. 
